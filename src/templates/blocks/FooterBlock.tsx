            ...
            <div className="space-y-3">
              ...
              <div className="p-3.5 rounded-xl border border-[color:var(--ts-accent-border)] bg-[color:var(--ts-surface)] space-y-2">
                ...
                <p className="text-[10px] text-[color:var(--ts-muted)]">
                  Treasurer: <strong className="text-[color:var(--ts-text)]">{business.treasurerName || (business.name.toLowerCase().includes('trevino') ? 'Joseph S. Boyle' : business.name.toLowerCase().includes('rogers') ? 'Sarah Jenkins' : 'Marcus Sterling')}</strong>. Contributions are not tax-deductible for federal income tax purposes.
                </p>
