  ...
  return (
    <div className="space-y-6 animate-in fade-in duration-500">
      ...
      <div className="flex items-center justify-between">
        <div>
          <p className="text-[10px] font-black text-[#d4693f] uppercase tracking-widest font-mono mb-1">REVENUE</p>
      ...
      <div className="grid grid-cols-2 md:grid-cols-3 gap-4 mb-2">
        <div className="bg-stone-900 rounded-2xl border border-stone-800 p-5 shadow-sm">
          <div className="flex items-center justify-between mb-3">
            ...
            <div className="w-7 h-7 rounded-[14px_6px_16px_8px/8px_16px_6px_14px] bg-[#d4693f]/10 border border-[#d4693f]/20 flex items-center justify-center text-[#d4693f]">
              <DollarSign className="w-3.5 h-3.5" />
            </div>
          </div>
          <p className="text-3xl font-bold text-[#d4693f]">
        ...
        {filteredInvoices.length === 0 ? (
          <div className="flex flex-col items-center justify-center py-16 text-center bg-stone-900 border border-stone-800 rounded-2xl">
            <div className="w-12 h-12 rounded-[14px_6px_16px_8px/8px_16px_6px_14px] bg-[#d4693f]/10 border border-[#d4693f]/20 flex items-center justify-center mb-4">
              <Receipt className="w-6 h-6 text-[#d4693f]" />
            </div>
          ...
          filteredInvoices.map((invoice) => (
            <div key={invoice.id} className="bg-stone-900 border border-stone-800 rounded-2xl p-4 hover:border-stone-700 transition-all group">
              <div className="flex items-start justify-between gap-4">
                ...
                <div className="flex gap-3 items-center min-w-0">
                  ...
                  <div className="min-w-0">
                    ...
                    <p className="text-[10px] font-mono text-[#d4693f] mt-0.5">{invoice.id}</p>
              ...
              <div className="flex items-center gap-2 mt-4 pt-3 border-t border-stone-800/60">
                <button className="flex items-center gap-1.5 px-3 py-1.5 text-[10px] font-bold text-[#d4693f] bg-[#d4693f]/10 hover:bg-[#d4693f]/20 border border-[#d4693f]/30 rounded-lg transition-all cursor-pointer">
